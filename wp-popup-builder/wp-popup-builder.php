...
if (!function_exists('wppb_loaded_pro')) {
  ...
  if (!function_exists('wppb_plugin_action_links')) {
    ...
    function wppb_plugin_action_links($links)
    {
      ...
      $settings_link = '<a href="' . esc_url($settings_page) . '">' . esc_html__('Settings', 'wppb') . '</a>';
  ...
  if (!function_exists('plugin_meta_links')) {
    ...
    function plugin_meta_links($links, $file)
    {
      ...
      $demo_link = '<a target="_blank" href="https://themehunk.com/wp-popup-builder-pro/#demos" title="' . esc_html__('Live Demo', 'wppb') . '"><span class="dashicons  dashicons-laptop"></span>' . esc_html__('Live Demo', 'wppb') . '</a>';

      $doc_link = '<a target="_blank" href="https://themehunk.com/docs/wp-popup-builder/" title="' . esc_html__('Documentation', 'wppb') . '"><span class="dashicons  dashicons-search"></span>' . esc_html__('Documentation', 'wppb') . '</a>';

      $support_link = '<a target="_blank" href="https://themehunk.com/contact-us/" title="' . esc_html__('Support', 'wppb') . '"><span class="dashicons  dashicons-admin-users"></span>' . esc_html__('Support', 'wppb') . '</a>';

      $pro_link = '<a target="_blank" href="https://themehunk.com/wp-popup-builder-pro/" title="' . esc_html__('Premium Version', 'wppb') . '"><span class="dashicons  dashicons-cart"></span>' . esc_html__('Premium Version', 'wppb') . '</a>';
